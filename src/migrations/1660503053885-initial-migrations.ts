...
export class initialMigrations1660503053885 implements MigrationInterface {
    name = 'initialMigrations1660503053885'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "anuncio" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "titulo" character varying NOT NULL, "preco" character varying NOT NULL, "ano" integer NOT NULL, "categoria" character varying NOT NULL, "quilometragem" integer NOT NULL, "descricao" text NOT NULL, "tipo" character varying NOT NULL, "publicado" boolean NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_5541bfac946f277f59379e45014" PRIMARY KEY ("id"))`);
